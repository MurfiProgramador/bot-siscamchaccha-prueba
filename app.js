...
const flowSecundario = addKeyword(['2', 'siguiente']).addAnswer(['Bien ahora le comunico con un asesor humano 👨‍💻 espero haberle ayudado 🤖'])
...
const flowGra = addKeyword(['gracias', 'listo','ok','vale','chau']).addAnswer(['Espero haberle ayudado,tenga un buen dia y a nombre de nuestra empresa le deseamos FELIZ NAVIDAD🎅🎄 Y PROSPERO AÑO NUEVO🎆🎉🤝']
)
...
const flowPrincipal = addKeyword(['hola', 'ole', 'alo'])
    .addAnswer('🙌 Hola Bienvenido, Soy el *Chatbot* 🤖 de *SISCAMCHACCHA* estare para apoyarlo🤝', {
    ...
    .addAnswer(
        ...
        null,
        null,
        [flowInfo, flowProduc, flowInsta, flowMante, flowGra]
    )
